...
test('checked-in examples are generated from the exporter and match their contracts', () => {
...
test('the validator enforces every keyword it is given and rejects unknown ones', () => {
  ...
  for (const name of ['evaluation-report.v1', 'evaluation-bundle.v1', 'evaluation-receipt.v1']) assert.equal(loadContract(name).$schema, 'https://json-schema.org/draft/2020-12/schema');
