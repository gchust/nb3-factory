...
try {
  ...
  await page.setContent(
    '<!doctype html><html lang="zh-CN"><meta charset="utf-8"><style>body{font:24px sans-serif;padding:32px}h1{font-size:32px}</style><h1>中文字体回归测试</h1><p id="chinese">会议室预约、行政部、领用归还、操作成功</p><p>English 123 · 中文標點，。</p></html>',
  );
  ...
  assert.ok(
    ...
    'Chinese glyphs must actually render using a CJK font',
  );
