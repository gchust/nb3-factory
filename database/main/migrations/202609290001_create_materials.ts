...
// The table behind the one-page material library. It is a plain table with an
// explicit string primary key: business code assigns the id, so seed rows and
// test fixtures have stable identifiers, and no relation is needed for the
// permission scenarios this application demonstrates.
