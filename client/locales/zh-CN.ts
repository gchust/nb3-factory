...
const zhCN: AppResource = {
  ...
  serviceRequests: {
    title: '受理请求',
    description:
      '创建请求、选择负责人，然后受理请求以运行受理工作流并通知负责人。',
    newRequest: '新建请求',
    newRequestDescription: '登记一条请求，并选择负责处理它的人。',
    assigneePlaceholder: '选择负责人',
    accept: '受理',
    accepted: '请求已受理',
    acceptFailed: '无法受理请求',
    acceptForbidden: '你没有受理请求的权限。',
    acceptFailedDescription: '受理工作流未完成，请重试。',
    created: '请求已创建',
    createFailed: '无法创建请求',
    createFailedDescription: '请求未保存，请重试。',
    titleRequired: '请输入请求标题。',
    urgent: '紧急',
    normal: '普通',
    columns: {
      title: '标题',
    ...
    empty: {
      title: '暂无受理请求',
      description: '创建第一条请求并选择负责人。',
    },
    error: {
      title: '无法加载受理请求',
      forbidden: '你没有查看受理请求的权限。',
    ...
    detail: {
      ...
      updatedAtLabel: '更新时间',
      notFound: '此受理请求已不存在。',
      hint: '受理会运行受理工作流，并向负责人发送一条持久的站内消息。',
    },
  },
  dataTable: {
    noResults: '暂无数据。',
