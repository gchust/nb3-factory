...
const zhCN: AppResource = {
  ...
  todos: {
    title: '待办事项',
    description: '已过截止时间且未完成的待办会被定时检查标记为已过期。',
    refresh: '刷新',
    newTodo: '新建待办',
    newTodoDescription: '添加一条带截止时间的待办。',
    create: '创建',
    scheduledHint: '“检查过期待办”计划会标记已过截止时间且未完成的待办。',
    completed: '已完成',
    incomplete: '未完成',
    expired: '已过期',
    active: '未过期',
    ...
    error: {
      forbidden: '你没有访问该列表的权限。',
      requestFailed: '无法加载待办。',
      retry: '重试',
      createFailed: '无法创建待办。',
      updateFailed: '无法更新待办。',
      titleRequired: '标题不能为空。',
      dueAtRequired: '截止时间不能为空。',
    },
  },
  dataTable: {
    noResults: '暂无数据。',
