...
const zhCN: AppResource = {
  ...
  'auth.trialRoleProductionLeadTwo': '生产负责人（第二名）— 独立的整改范围',
  'status.loading': '加载中',
  ...
  quality: {
    ...
    tasks: {
      ...
      reassignTitle: '改派检验员',
      reassignHint:
        '改派后新检验员立即获得访问权限，原检验员通过旧链接将无法再打开该任务及其资料。',
      reassign: '改派',
      itemsTitle: '检查项目',
    ...
    nc: {
      ...
      currentRound: '当前轮次',
      pastRound: '往轮留存',
      pastRoundHint: '往轮资料作为留存保留，不可修改或覆盖。',
      reviewHistory: '复核记录',
      reviewDecision: { close: '同意关闭', return: '退回' },
      reassignTitle: '改派生产负责人',
      reassignHint:
        '改派后新负责人立即获得访问权限，原负责人将无法再打开该整改及其资料。',
      reassignLead: '生产负责人',
      reassign: '改派',
      saveDraft: '暂存',
      submitReview: '提交复核',
