...
const zhCN: AppResource = {
  ...
  customerMemos: {
    title: '客户备忘录',
    description: '为每位客户记录的简短备注。',
    createAction: '新建备忘录',
    createTitle: '新建客户备忘录',
    createSuccess: '客户备忘录已创建。',
    editTitle: '编辑客户备忘录',
    editSuccess: '客户备忘录已保存。',
    detailTitle: '客户备忘录',
    view: '查看',
    edit: '编辑',
    delete: '删除',
    ...
    required: '请输入客户名称。',
    nameTooLong: '客户名称最多 200 个字符。',
    noteTooLong: '备注最多 2000 个字符。',
    namePlaceholder: '请输入客户名称',
    notePlaceholder: '添加备注（可选）',
    deleteTitle: '删除“{{name}}”？',
    deleteDescription: '该客户备忘录将被永久删除。',
    deleteSuccess: '“{{name}}”已删除。',
    deleteNotFound: '“{{name}}”已被删除。',
    fields: {
      name: '客户名称',
      note: '备注',
      createdAt: '创建时间',
