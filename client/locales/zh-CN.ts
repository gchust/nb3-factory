...
const zhCN: AppResource = {
  ...
  memos: {
    ...
    createdAt: '创建时间',
    actions: '操作',
    empty: '暂无备忘录，新增第一条记录吧。',
    noResults: '没有与“{{query}}”匹配的备忘录。',
    loadFailed: '加载备忘录失败，请重试。',
    createTitle: '新增备忘录',
    editTitle: '编辑备忘录',
    formDescription: '客户名称为必填项，备注可选。',
    customerNameRequired: '请填写客户名称。',
    saveFailed: '保存备忘录失败，请重试。',
    deleteTitle: '删除备忘录',
    deleteDescription: '确定删除“{{name}}”的备忘录吗？此操作无法撤销。',
    deleteFailed: '删除备忘录失败，请重试。',
    edit: '编辑',
    delete: '删除',
    editLabel: '编辑 {{name}} 的备忘录',
    deleteLabel: '删除 {{name}} 的备忘录',
  },
  navigation: {
    home: '首页',
    memos: '客户备忘录',
