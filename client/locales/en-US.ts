...
const enUS = {
  ...
  customerMemos: {
    ...
    customerNamePlaceholder: 'Enter a customer name',
    customerNameRequired: 'Customer name is required.',
    note: 'Notes',
    notePlaceholder: 'Add notes (optional)',
    noNote: 'No notes',
    createdAt: 'Created',
    actions: 'Actions',
    edit: 'Edit',
    ...
    noResults: 'No customer memos match your search.',
    loading: 'Loading customer memos…',
    loadFailed: 'Unable to load customer memos.',
    retry: 'Retry',
    saving: 'Saving…',
    saveFailed: 'Unable to save the customer memo.',
    deleteTitle: 'Delete customer memo',
    deleteDescription: 'Delete the memo for "{{name}}"? This cannot be undone.',
    deleteConfirm: 'Delete',
    deleting: 'Deleting…',
    deleteFailed: 'Unable to delete the customer memo.',
  },
  appearance: {
    title: 'Appearance',
    mode: 'Color mode',
