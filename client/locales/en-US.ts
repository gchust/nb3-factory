...
const enUS = {
  ...
  teamTasks: {
    title: 'Team tasks',
    description: 'A lightweight checklist shared by the whole team.',
    newTask: 'New task',
    createTitle: 'New task',
    editTitle: 'Edit task',
    formDescription: 'Add the details for this task.',
    titleLabel: 'Title',
    ...
    emptyDescription: 'There is nothing matching this filter.',
    readOnly:
      'You can view and filter tasks. Only administrators can change them.',
    created: 'Task created.',
    updated: 'Task updated.',
    completed: 'Task marked complete.',
    loading: 'Loading tasks',
    loadFailed: 'Unable to load tasks. Please try again.',
    saveFailed: 'Unable to save the task. Please try again.',
