...
const enUS = {
  ...
  memos: {
    ...
    description: 'Keep track of notes about your customers.',
    add: 'Add memo',
    ...
    actions: 'Actions',
    empty: 'No memos yet. Add your first memo to get started.',
    noResults: 'No memos match "{{query}}".',
    loadFailed: 'Unable to load memos. Please try again.',
    createTitle: 'Add memo',
    editTitle: 'Edit memo',
    formDescription: 'The customer name is required; the memo is optional.',
    customerNameRequired: 'Customer name is required.',
    saveFailed: 'Unable to save the memo. Please try again.',
    deleteTitle: 'Delete memo',
    deleteDescription:
      'Delete the memo for "{{name}}"? This action cannot be undone.',
    deleteFailed: 'Unable to delete the memo. Please try again.',
    edit: 'Edit',
    delete: 'Delete',
    editLabel: 'Edit memo for {{name}}',
    deleteLabel: 'Delete memo for {{name}}',
  },
  navigation: {
    home: 'Home',
