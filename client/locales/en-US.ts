...
const enUS = {
  ...
  customerMemos: {
    ...
    description: 'Short notes kept against each customer.',
    createAction: 'New memo',
    createTitle: 'New customer memo',
    createSuccess: 'Customer memo created.',
    editTitle: 'Edit customer memo',
    editSuccess: 'Customer memo saved.',
    detailTitle: 'Customer memo',
    view: 'View',
    edit: 'Edit',
    delete: 'Delete',
    actions: 'Actions',
    ...
    empty: 'No customer memos yet.',
    loadFailed: 'Unable to load customer memos.',
    ...
    nameTooLong: 'The customer name must be at most 200 characters.',
    noteTooLong: 'The note must be at most 2000 characters.',
    namePlaceholder: 'Enter the customer name',
    notePlaceholder: 'Add a note (optional)',
    deleteTitle: 'Delete “{{name}}”?',
    deleteDescription: 'This customer memo will be removed permanently.',
    deleteSuccess: '“{{name}}” was deleted.',
    deleteNotFound: '“{{name}}” had already been deleted.',
    fields: {
      name: 'Customer name',
      note: 'Note',
