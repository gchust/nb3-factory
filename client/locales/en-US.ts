...
const enUS = {
  ...
  'navigation.itTickets': 'IT tickets',
  ...
  itTickets: {
    title: 'IT tickets',
    description: 'Submit an IT request and follow it through to resolution.',
    searchPlaceholder: 'Search tickets',
    unassigned: 'Unassigned',
    cancel: 'Cancel',
    empty: 'No tickets yet.',
    emptyFiltered: 'No tickets match this status.',
    tabs: {
      all: 'All',
    },
    status: {
    ...
    create: {
      title: 'New ticket',
      description: 'Describe the problem and an IT handler will pick it up.',
      titleLabel: 'Title',
      titlePlaceholder: 'A short summary of the problem',
      titleRequired: 'Enter a short title.',
    ...
    complete: {
      ...
      description: 'Record what was done to resolve “{{title}}”.',
      noteLabel: 'Resolution note',
      notePlaceholder: 'What was done to resolve the ticket?',
      noteRequired: 'Describe how the ticket was resolved.',
    ...
    toasts: {
      createdTitle: 'Ticket submitted',
      startedTitle: 'Processing started',
      startedDescription: 'You are now handling “{{title}}”.',
      completedTitle: 'Ticket completed',
      completedDescription: '“{{title}}” is resolved.',
      errorTitle: 'Something went wrong',
    },
    errors: {
      unauthorized: 'Your session has expired. Please sign in again.',
      forbidden: 'You are not allowed to do that.',
      notFound: 'The ticket no longer exists.',
      invalidState: 'The ticket cannot be changed in its current state.',
      invalidInput: 'Check the details you entered and try again.',
      generic: 'The request failed. Please try again.',
    },
    roles: {
      employee: 'IT ticket employee',
      handler: 'IT ticket handler',
    },
  },
