...
/** Route `/customer-memos/new`: create a memo, presented as a dialog over the list. */
export default function NewCustomerMemoPage(): ReactElement {
  ...
  return (
    <RouteDialog
      ...
      description={t('customerMemos.create.description')}
...
function NewCustomerMemoBody({
  ...
  return (
    <CustomerMemoForm
      ...
      onSubmitted={() => {
        // Refresh the list behind first; the form has already shown the success message.
        reload();
        void close();
      }}
    />
