...
export default function CustomerMemosPage(): ReactElement {
  ...
  function scheduleSearch(value: string): void {
    ...
    // While the timer runs, only outside navigation can change q. If it did, drop this write and let the navigation stand.
  ...
  // Decide by the input's text, so "Clear search" appears as soon as the first character is typed.
  ...
  function clearFilters(): void {
    ...
    // The button disappears along with the filter; move focus to the search box.
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <span className='whitespace-nowrap text-muted-foreground'>
            {dateFormat.format(parseMemoTimestamp(row.original.createdAt))}
          </span>
        ),
      },
      {
