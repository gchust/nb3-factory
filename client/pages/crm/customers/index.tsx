...
import type { Customer, CrmListOutletContext } from '../types.js';
...
export default function CustomersPage(): ReactElement {
  ...
  // The latest query parameters: the ones this page wrote, or the router
  // updated. Every change starts from this value so two quick writes do not
  ...
  // The box text lives in component state and reaches the URL 300ms after
  // typing stops; requests follow the URL.
              ...
              <DropdownMenuTrigger
                render={
                  <Button
                    variant='ghost'
                    size='icon-sm'
                    aria-label={t('crm.customers.actions.more', {
    ...
    content = (
      <Empty className='border'>
        <EmptyHeader>
          ...
          <EmptyTitle>{t('crm.customers.empty.title')}</EmptyTitle>
          <EmptyDescription>
            {t('crm.customers.empty.description')}
          </EmptyDescription>
        </EmptyHeader>
        <EmptyContent>
          <Button
      ...
      <DataTable
        ...
        emptyMessage={
          <div className='flex flex-col items-center gap-2'>
            <span>{t('crm.customers.empty.noResults')}</span>
      ...
      <div className='flex flex-wrap items-center gap-2'>
        <InputGroup className='w-full sm:max-w-xs'>
          ...
          <InputGroupInput
            ...
            placeholder={t('crm.customers.search.placeholder')}
            aria-label={t('crm.customers.search.label')}
          />
        </InputGroup>
        {hasFilters ? (
