...
export interface ContactFormProps {
  ...
  /** For a contact created from a customer's detail view: preselect that customer. */
...
/** One form for creating (`POST`) and editing (`PATCH`) a contact. */
    ...
    () =>
      z.object({
        ...
        contactInfo: z
          ...
          .max(
            CONTACT_INFO_MAX,
            t('crm.form.contactInfoTooLong', { max: CONTACT_INFO_MAX }),
          ),
    ...
    <form id={formId} noValidate onSubmit={(event) => void onSubmit(event)}>
      <FieldGroup>
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid}>
              <FieldLabel htmlFor={`${formId}-contactInfo`}>
