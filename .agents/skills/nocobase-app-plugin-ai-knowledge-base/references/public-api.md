...
| `@nocobase/app-plugin-ai-knowledge-base/client/routes`           | Default Dev route contribution (unchanged); named `settingsRoutes` contains independent Knowledge bases/Vector databases Settings routes and guarded descendants.   |
