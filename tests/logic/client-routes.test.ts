...
describe('app client routes', () => {
  ...
  it('pins the route names page grants are stored against', () => {
    ...
    // The landing page and the To-do list opted out of page authorization, so they are reachable by every signed-in
    // user. A page that requires a grant adds its resource id here instead of `null`.
