...
describe('client inspection', () => {
  ...
  it('inspects configured Client contributions without running lifecycle or leaf loaders', async () => {
    ...
    expect(
      ...
      {
        auth: 'required',
        id: 'nb3-factory:templates',
        path: '/templates',
      },
      {
        auth: 'required',
        id: 'nb3-factory:inspections',
        path: '/inspections',
      },
      {
        auth: 'required',
        id: 'nb3-factory:inspection-detail',
        path: '/inspections/:id',
      },
      {
        auth: 'required',
        id: 'nb3-factory:repairs',
        path: '/repairs',
      },
      {
        auth: 'required',
        id: 'nb3-factory:repair-detail',
        path: '/repairs/:id',
      },
      {
        auth: 'required',
      ...
      {
        auth: 'guest',
        id: 'nb3-factory:register',
        path: '/register',
      },
      {
        auth: 'guest',
        id: 'nb3-factory:forgot-password',
    ...
    expect(
      ...
      { packageName: 'nb3-factory', order: 1 },
